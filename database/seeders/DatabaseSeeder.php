...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $artist_weekend_id = DB::table('artists')->insertGetId(['name' => 'The Weeknd', 'created_at' => Carbon::now()]);
        ...
        $album_starboy_id = DB::table('albums')->insertGetId(['title' => 'Starboy', 'year' => 2023, 'created_at' => Carbon::now()]);
        ...
        $song24 = DB::table('songs')->insertGetId(['name' => 'Starboy (feat. Daft Punk)', 'album_id'=>$album_starboy_id, 'duration'=>334, 'created_at' => Carbon::now()]);
        ...
        DB::table('artist_song')->insert(['song_id' => $song24, 'artist_id'=>$artist_weekend_id]);
